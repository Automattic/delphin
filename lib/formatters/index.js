...
/***
 * Wraps a function with preventWindows
 * Non-strings are passed-threw
 *
 * @param {Function} wrappedFunction a function to wrap
 * @param {Number} wordsToKeep amount of words to keep, passed to preventWindows
 * @returns {Function} a function that wraps wrappedFunction and calls preventWindows on the result
 */
export const withPreventWidows = ( wrappedFunction, wordsToKeep = 2 ) => ( ...args ) =>
	preventWidows( wrappedFunction( ...args ), wordsToKeep );
