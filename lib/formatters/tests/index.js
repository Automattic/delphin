...
describe( 'camelizeKeys', () => {
	...
	it( 'should handle array as the top object', () => {
		expect( camelizeKeys( [ { foo_bar: 1 },  { hello_world: 2 } ] ) )
			.toEqual( [ { fooBar: 1 }, { helloWorld: 2 } ] );
	} );
} );
...
describe( 'preventWidows', () => {
	...
	it( 're-applying should add non-breaking space if required', () => {
		const input = 'I really love BBQ. It is one of my favorite foods. Beef ribs are amazing.';
